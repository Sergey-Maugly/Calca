...
//сделать инженерный калькулятор после курса//
...
import com.example.calca.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Вот и всё малята. Через год, (22.11.2021) запилю своё приложение в Пугл и Апстор//
}
